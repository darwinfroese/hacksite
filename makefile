...
LOCAL_BUILD_FLAGS=-ldflags "-X server/cmd/server.envFile=${LOCAL_ENVIRONMENT_FILE}"
PROD_BUILD_FLAGS=-ldflags "-X server/cmd/server.envFile=${PROD_ENVIRONMENT_FILE}"
